...
public class TranscriptTest {
    ...
    private String name = "NM_032291";
    private String gene = "SGIP1";
    private String strand = "+";
    private int exonCount = 2;
    private Interval transcriptInterval = new Interval("chr1",66999824,67210768);
    private Interval codingInterval = new Interval("chr1",67000041,67208778);
    ...
    public void setUp() {
        ...
        exons = new ArrayList<>();
        exons.add(new Interval("chr1",66999824,67000051,FALSE,"1"));
        exons.add(new Interval("chr1",67091529,67091593,FALSE,"2"));
    ...
    public void testGet5primeExonFW() {
        ...
        Interval firstExon = transcript.get5primeExon();
    ...
    public void testGetNextExonFW() {
        ...
        Interval nextExon = transcript.getNextExon();
    ...
    public void testGet5primeExonRC() {
        ...
        List<Interval> rcExons = new ArrayList<>();
        rcExons.add(new Interval("chr1",66999824,67000051,FALSE,"2"));
        rcExons.add(new Interval("chr1",67091529,67091593,FALSE,"1"));
        
        Transcript t = new Transcript(
            name,gene,"-",exonCount,transcriptInterval,codingInterval,rcExons);
        
        Interval firstExon = t.get5primeExon();
