 ...
 * @author evanmauceli
 */
public class GeneModelFileReader {
     ...
     */
    public GeneModelFileReader(String file) 
    throws FileNotFoundException {
    ...
    throws IOException {
        ...
        while (reader.ready()) {
            ...
            if (!line.isEmpty()) {
                ...
                if (transcript != null) {
                    geneModel.addTranscript(transcript);
                }  
            }
        }              
    }
    ...
    /**
     * Method to convert exon (start,end) coordinates to a list of Interval 
     * objects. 
     ...
     */
    protected List<Interval> parseExons(
